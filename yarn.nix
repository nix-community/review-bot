{ fetchurl, fetchgit, linkFarm, runCommand, gnutar }: rec {
  ...
  packages = [
    ...
    {
      name = "_octokit_app___app_12.0.5.tgz";
      path = fetchurl {
        name = "_octokit_app___app_12.0.5.tgz";
        url  = "https://registry.yarnpkg.com/@octokit/app/-/app-12.0.5.tgz";
    ...
    {
      name = "_octokit_auth_unauthenticated___auth_unauthenticated_2.1.0.tgz";
      path = fetchurl {
        name = "_octokit_auth_unauthenticated___auth_unauthenticated_2.1.0.tgz";
        url  = "https://registry.yarnpkg.com/@octokit/auth-unauthenticated/-/auth-unauthenticated-2.1.0.tgz";
    ...
    {
      name = "_octokit_oauth_app___oauth_app_3.6.0.tgz";
      path = fetchurl {
        name = "_octokit_oauth_app___oauth_app_3.6.0.tgz";
        url  = "https://registry.yarnpkg.com/@octokit/oauth-app/-/oauth-app-3.6.0.tgz";
    ...
    {
      name = "_octokit_plugin_retry___plugin_retry_3.0.9.tgz";
      path = fetchurl {
        name = "_octokit_plugin_retry___plugin_retry_3.0.9.tgz";
        url  = "https://registry.yarnpkg.com/@octokit/plugin-retry/-/plugin-retry-3.0.9.tgz";
        sha512 = "r+fArdP5+TG6l1Rv/C9hVoty6tldw6cE2pRHNGmFPdyfrc696R6JjrQ3d7HdVqGwuzfyrcaLAKD7K8TX8aehUQ==";
      };
    }
    {
      name = "_octokit_plugin_throttling___plugin_throttling_3.6.1.tgz";
      path = fetchurl {
        name = "_octokit_plugin_throttling___plugin_throttling_3.6.1.tgz";
        url  = "https://registry.yarnpkg.com/@octokit/plugin-throttling/-/plugin-throttling-3.6.1.tgz";
    ...
    {
      name = "_octokit_webhooks_types___webhooks_types_5.2.0.tgz";
      path = fetchurl {
        name = "_octokit_webhooks_types___webhooks_types_5.2.0.tgz";
        url  = "https://registry.yarnpkg.com/@octokit/webhooks-types/-/webhooks-types-5.2.0.tgz";
        sha512 = "OZhKy1w8/GF4GWtdiJc+o8sloWAHRueGB78FWFLZnueK7EHV9MzDVr4weJZMflJwMK4uuYLzcnJVnAoy3yB35g==";
      };
    }
    {
      name = "_octokit_webhooks___webhooks_9.22.0.tgz";
      path = fetchurl {
        name = "_octokit_webhooks___webhooks_9.22.0.tgz";
        url  = "https://registry.yarnpkg.com/@octokit/webhooks/-/webhooks-9.22.0.tgz";
        sha512 = "wUd7nGfDRHG6xkz311djmq6lIB2tQ+r94SNkyv9o0bQhOsrkwH8fQCM7uVsbpkGUU2lqCYsVoa8z/UC9HJgRaw==";
      };
    }
    {
    ...
    {
      name = "_types_aws_lambda___aws_lambda_8.10.93.tgz";
      path = fetchurl {
        name = "_types_aws_lambda___aws_lambda_8.10.93.tgz";
        url  = "https://registry.yarnpkg.com/@types/aws-lambda/-/aws-lambda-8.10.93.tgz";
        sha512 = "Vsyi9ogDAY3REZDjYnXMRJJa62SDvxHXxJI5nGDQdZW058dDE+av/anynN2rLKbCKXDRNw3D/sQmqxVflZFi4A==";
      };
    }
    {
    ...
    {
      name = "config___config_3.3.7.tgz";
      path = fetchurl {
        name = "config___config_3.3.7.tgz";
        url  = "https://registry.yarnpkg.com/config/-/config-3.3.7.tgz";
    ...
    {
      name = "matrix_bot_sdk___matrix_bot_sdk_0.5.19.tgz";
      path = fetchurl {
        name = "matrix_bot_sdk___matrix_bot_sdk_0.5.19.tgz";
        url  = "https://registry.yarnpkg.com/matrix-bot-sdk/-/matrix-bot-sdk-0.5.19.tgz";
    ...
    {
      name = "octokit___octokit_1.7.1.tgz";
      path = fetchurl {
        name = "octokit___octokit_1.7.1.tgz";
        url  = "https://registry.yarnpkg.com/octokit/-/octokit-1.7.1.tgz";
        sha512 = "1b7eRgU8uWetHOWr8f9ptnVo2EKbrkOfocMeQdpgCt7tl/LK67HptFsy2Xg4fMjsJ/+onoBJW0hy/fO0In3/uA==";
      };
    }
    {
    ...
    {
      name = "postcss___postcss_8.4.7.tgz";
      path = fetchurl {
        name = "postcss___postcss_8.4.7.tgz";
        url  = "https://registry.yarnpkg.com/postcss/-/postcss-8.4.7.tgz";
    ...
    {
      name = "ts_node___ts_node_10.6.0.tgz";
      path = fetchurl {
        name = "ts_node___ts_node_10.6.0.tgz";
        url  = "https://registry.yarnpkg.com/ts-node/-/ts-node-10.6.0.tgz";
        sha512 = "CJen6+dfOXolxudBQXnVjRVvYTmTWbyz7cn+xq2XTsvnaXbHqr4gXSCNbS2Jj8yTZMuGwUoBESLaOkLascVVvg==";
      };
    }
    {
